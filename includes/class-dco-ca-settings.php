...
class DCO_CA_Settings extends DCO_CA_Base {
	...
	public function create_menu() {
		add_options_page( __( 'WordPress Comment Attachment Settings', 'dco-comment-attachment' ), esc_html__( 'WordPress Comment Attachment', 'dco-comment-attachment' ), 'manage_options', 'dco-comment-attachment', array( $this, 'render' ) );
	}
	...
	public function render() {
		?>
		<div class="wrap">
			<h1><?php esc_html_e( 'WordPress Comment Attachment Settings', 'dco-comment-attachment' ); ?></h1>
